...
function Home() {
  return (
    <div className="bg-slate-500  ">
      <br></br>
      <h1 className="text-6xl font-serif text-zinc-700 text-center">
        SEWA RUANG
      </h1>
      <img
        style={{ display: "flex", margin: "auto", borderRadius: "20px" }}
        src={ruangRapat}
        alt="ruang Rapat"
      />
      <br></br>
      <h4 style={{ textAlign: "center" }}>Ciptakan Ruangan Impian Anda</h4>
      <button
        style={{
          display: "flex",
          margin: "auto",
      ...
      <div className="bg-slate-200  ">
        ...
        <div class="grid grid-cols-1 gap-7 lg:grid-cols-2 ">
          ...
          <div className="	flex justify-center flex-col px-20">
            {" "}
            <h1 className="text-6xl font-serif text-zinc-700">Kamar VIP</h1>
            <p className="text-4xl font-mono text-zinc-500  w-96">
              Kamar dengan view kolam renang menenangkan siap membuat keluarga
              Anda lebih harmonis.
            </p>
            <button className="bg-zinc-700 rounded-lg w-40 h-10 text-zinc-500">
              Lihat Detail
            </button>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-7 lg:grid-cols-2 lg:gap-8">
          <div className=" flex justify-center flex-col px-20">
            {" "}
            <h1 className="text-6xl font-serif text-zinc-700  w-96">
          ...
          <div className="	flex justify-center">
            {" "}
            <img src={rooftop} alt="rooftop" className="rounded-3xl  w-3/4 " />
          </div>
        </div>
        <br></br>
        <br></br>
        <div className="bg-slate-500  flex justify-center flex-col items-center">
          <h1 className="	flex justify-center text-8xl">FAQ</h1>
