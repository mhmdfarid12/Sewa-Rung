...
function Home() {
  return (
    <div className="bg-[#B9B4C7] py-2.5 ">
      ...
      <br></br>
      <h4 className="text-4xl font-mono text-zinc-700 text-center">
      ...
      <div className="bg-slate-200  ">
        ...
        <div className="bg-[#B9B4C7]  flex justify-center flex-col items-center  h-96">
          <h1 className="	flex justify-center text-6xl my-6 font-bold">FAQ</h1>
          <div class="bg-gray-200 w-full sm:w-1/2 lg:w-1/2  divide-y divide-gray-500 rounded-2xl   ">
            <details>
        ...
        <div>
          <h1 className="	flex justify-center text-6xl my-8 font-bold">
            Sign up today
          </h1>
          <div className="flex items-center justify-center">
            <button className="bg-zinc-700 rounded-lg w-40 h-10 text-slate-50 items-center my-6 font-semibold">
              Get started
            </button>
          </div>
