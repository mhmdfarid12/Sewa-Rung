...
function Add() {
  return (
    ...
    "
    >
      <div className=" w-[200px]  h-[150px] rounded-t-[20px]  md:w-[300px] md:h-[300px] md:rounded-l-3xl md:rounded-r-none bg-slate-50  lg:w-96 lg:h-[450px] lg:rounded-l-3xl  lg:rounded-t-r-3xl  flex justify-center items-center">
        <img src={logoV2} alt="logoV2" className=" w-3/4 w-[100%]" />
      </div>
      <div className="  w-[200px]  h-[200px] rounded-b-[20px]   bg-[#393646]  md:w-[300px] md:h-[300px]  md:rounded-r-3xl md:rounded-l-none lg:w-96 lg:h-[450px] lg:rounded-r-3xl lg:rounded-l-none">
        <div className="">
